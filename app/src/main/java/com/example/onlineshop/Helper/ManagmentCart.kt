...
class ManagmentCart(val context: Context) {
    ...
    fun insertItems(item: ItemModels) {
    ...
    fun getListCart(): ArrayList<ItemModels> {
        return tinyDB.getListObject("CartList") ?: arrayListOf()
    }

    fun minusItem(listItems: ArrayList<ItemModels>, position: Int, listener: ChangeNumberItemsListener) {
    ...
    fun plusItem(listItems: ArrayList<ItemModels>, position: Int, listener: ChangeNumberItemsListener) {
        listItems[position].numberInCart++
        tinyDB.putListObject("CartList", listItems)
        listener.onChanged()
    }
