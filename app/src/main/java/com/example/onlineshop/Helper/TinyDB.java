...
public class TinyDB {
    ...
    public ArrayList<ItemModels> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ItemModels> playerList = new ArrayList<ItemModels>();

        for (String jObjString : objStrings) {
            ItemModels player = gson.fromJson(jObjString, ItemModels.class);
    ...
    public void putListObject(String key, ArrayList<ItemModels> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (ItemModels player : playerList) {
